// Financial Tracker Controller
// still working on how to build it.
...
const createEntry = async (req, res, next) => {
    ...
    try {
        res.status(201).json({ success: { message: "You've successfully created an entry on the page" }, statusCode: 201 });        
